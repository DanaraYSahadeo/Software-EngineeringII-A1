...
def add_competition(competition_name, admin_user):  # Add a new competition, ensuring that only admins can create competitions.
...
def get_competition_by_name(competition_name): # Return the first matching competition.
...
def get_all_competitions_json(): # Return all competitions in JSON format.
...
def list_competitions(): # List all competitions, including those imported from data.csv and newly created ones.
